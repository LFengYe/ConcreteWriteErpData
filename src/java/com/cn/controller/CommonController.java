...
public class CommonController {
     ...
     * @throws java.lang.Exception
     */
    public ArrayList<Integer> dataBaseOperateSpecial(String datas, String className, String tableName, String operate, String connType) throws Exception {
        ArrayList<Integer> results = new ArrayList<>();
        int[] exeResult = null;
        ...
        try {
            ...
            switch (operate) {
                ...
                case "add": {
                    StringBuilder builder;
                    builder = new StringBuilder("insert into " + tableName + " () values ()");
                    JSONObject firstObj = arrayData.getJSONObject(0);
                    Iterator<String> keysIterator = firstObj.keySet().iterator();
                    while (keysIterator.hasNext()) {
                        String key = keysIterator.next();
                ...
                case "update": {
                    ...
                    StringBuilder builder;
                    builder = new StringBuilder("update " + tableName);
                    JSONObject firstSetObj = arrayData.getJSONObject(0);
                    JSONObject firstWhereObj = arrayData.getJSONObject(1);
                ...
                case "delete": {
                    StringBuilder builder;
                    builder = new StringBuilder("delete from " + tableName);
                    JSONObject firstObj = arrayData.getJSONObject(0);
